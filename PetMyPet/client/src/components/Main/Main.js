...
import OtherPetsList from "./OtherPetsList";
  ...
  return (
    <main id="site-content">
      ...
      <section class="deletePet">
        <h3>Pesho</h3>
        <p>
          Pet counter: <i class="fas fa-heart"></i> 5
        </p>
        <p class="img">
          <img src="http://pngimg.com/uploads/cat/cat_PNG50491.png" />
        </p>
      ...
      <section class="detailsMyPet">
        <h3>Koko</h3>
        <p>
          Pet counter: <i class="fas fa-heart"></i> 6
        </p>
        <p class="img">
          <img src="https://www.freepngimg.com/thumb/parrot/2-parrot-png-images-download-thumb.png" />
        </p>
        <form action="#" method="POST">
          <textarea type="text" name="description">
            This is my parrot Koko
          </textarea>
      ...
      <section class="detailsOtherPet">
        ...
        <p class="img">
          <img src="http://pngimg.com/uploads/horse/horse_PNG321.png" />
        </p>
